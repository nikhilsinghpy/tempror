        ...
        <CrouselCs>
          {Array.from({ length: 5 }).map((_, index) => (
            <CarouselItem key={index} className="lg:basis-1/3 py-4">
              <DoctorCard
                name="Dr. Rohan Mehta"
                specialty="Eyebrow Transplant Surgeon"
                ...
                bio={`Dr. Mehta is a leading eyebrow transplant expert with over a decade of experience in precision follicular restoration and aesthetic design.`}
